...
//            checking the duplicate contact by contact name.
    ...
    public void searchByName(String name) {
        List<Contact> collect = contact.stream().filter(p -> p.getFirstName().equalsIgnoreCase(name)).collect(Collectors.toList());
    ...
    public void searchByCity(String city) {
        List<Contact> collect = contact.stream().filter(p -> p.getCity().equalsIgnoreCase(city)).collect(Collectors.toList());
        for (Contact cont : collect) {
            System.out.println("Result: " + cont);
        }
    }

    public void searchByState(String state) {
        List<Contact> collect = contact.stream().filter(p -> p.getCity().equalsIgnoreCase(state)).collect(Collectors.toList());
        for (Contact cont : collect) {
            System.out.println("Result: " + cont);
        }
    }
